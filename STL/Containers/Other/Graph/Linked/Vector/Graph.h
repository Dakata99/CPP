...
protected:
    ...
    virtual void add_oriented_weighted_edge(const Vertex&, const Vertex&, const Edge& = Edge()) = 0;
    virtual void add_oriented_non_weighted_edge(const Vertex&, const Vertex&) = 0;
    
    virtual void add_non_oriented_weighted_edge(const Vertex&, const Vertex&, const Edge& = Edge()) = 0;
    virtual void add_non_oriented_non_weighted_edge(const Vertex&, const Vertex&) = 0;

    virtual void print_weighted() const = 0;
    virtual void print_non_weighted() const = 0;
